...
#######################################################################################
def random_date_between(start_str, end_str, date_format="%d-%m-%Y"):
    ...
    random_timestamp = start_timestamp + ((end_timestamp - start_timestamp) * random())
    # convert timestamp to date string and return it
